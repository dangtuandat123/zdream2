    ...
    'bfl' => [
        ...
        'models' => [
            [
                ...
                'description' => 'Inpaint/Outpaint (mask-based)',
                'generation_mode' => 'fill',
                ...
                'steps' => ['min' => 15, 'max' => 50, 'default' => 50],
                'guidance' => ['min' => 1.5, 'max' => 100, 'default' => 60],
                'safety_tolerance' => ['min' => 0, 'max' => 6, 'default' => 2],
            ],
            [
                'id' => 'flux-pro-1.0-fill-finetuned',
                'name' => 'FLUX.1 Fill Pro (Finetuned)',
                'description' => 'Inpaint/Outpaint (finetuned)',
                'generation_mode' => 'fill',
                'supports_image_input' => true,
                'supports_mask' => true,
                'supports_aspect_ratio' => false,
            ...
            [
                ...
                'name' => 'FLUX.1 Expand',
                'description' => 'Outpainting (expand image borders)',
            ...
            [
                ...
                'supports_raw' => false,
                'supports_image_prompt_strength' => false,
                'supports_blob_path' => true,
                'max_input_images' => 8,
                'output_formats' => ['jpeg', 'png'],
                'steps' => ['min' => 1, 'max' => 50, 'default' => 50],
                'guidance' => ['min' => 1.5, 'max' => 10, 'default' => 4.5],
                'safety_tolerance' => ['min' => 0, 'max' => 5, 'default' => 2],
                'min_dimension' => 64,
                'max_dimension' => 2048,
                'dimension_multiple' => 16,
