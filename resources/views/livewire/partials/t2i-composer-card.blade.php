    ...
    <div class="max-w-4xl mx-auto px-3 sm:px-4 pb-3 sm:pb-4 pt-2">
        ...
        <div class="relative transition-all duration-300 ease-in-out"
            ...
            <div class="relative flex flex-col gap-2.5 t2i-composer-card transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]"
                :class="!isAtBottom && !isFocused && !($wire.prompt?.length > 0) ? 'mx-auto w-full max-w-3xl rounded-2xl p-2 gap-0 bg-black/40 backdrop-blur-[80px] border border-white/10 shadow-2xl' : 'w-full rounded-2xl p-3 sm:p-4 bg-[#151515]/90 backdrop-blur-md border border-white/10'">
                ...
                <div class="relative flex items-center gap-2 w-full">
                    <textarea x-ref="promptInput" wire:model.live.debounce.500ms="prompt" rows="1"
                        ...
                        :class="!isAtBottom && !isFocused && !($wire.prompt?.length > 0) ? 'min-h-[44px] px-3 py-2.5 text-white/70 placeholder:text-white/40' : 'min-h-[48px] max-h-[120px] px-0'"
                        x-init="
