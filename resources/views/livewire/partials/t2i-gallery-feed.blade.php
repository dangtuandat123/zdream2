...
<div id="gallery-scroll" class="t2i-gallery-shell">
    ...
    <div x-show="loadingMoreHistory" wire:ignore
        ...
        <div class="flex justify-center mt-3">
            <div class="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gray-800 border border-gray-700">
                                        ...
                                        <div class="relative overflow-hidden bg-[#222] rounded-lg aspect-square">
                                            ...
                                            <div class="absolute top-2 right-2 flex gap-1.5 z-10 sm:opacity-0 sm:group-hover/img:opacity-100 transition-all duration-200">
                                                <button @click.stop="downloadImage('{{ $image->image_url }}')" 
                                                    class="h-8 w-8 rounded-full bg-black/70 text-white/90 hover:text-white hover:bg-black/90 flex items-center justify-center transition-all duration-200 active:scale-90" 
                                                    title="Tải xuống">
                                                ...
                                                <button wire:click="deleteImage({{ $image->id }})" @click.stop 
                                                    ...
                                                    class="h-8 w-8 rounded-full bg-black/70 text-white/90 hover:text-white hover:bg-red-600 flex items-center justify-center transition-all duration-200 active:scale-90" 
                                                    title="Xóa">
