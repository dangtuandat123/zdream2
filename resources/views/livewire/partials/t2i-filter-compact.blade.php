                    ...
                    <div class="hidden sm:flex items-center gap-1.5">
                            ...
                            <button @click="openFilter = openFilter === 'date' ? null : 'date'"
                                ...
                                @else
                                    <i class="fa-solid fa-chevron-down text-[8px] ml-0.5 transition-transform"
                                        aria-hidden="true" :class="openFilter === 'date' ? 'rotate-180' : ''"></i>
                                @endif
                            </button>
                        ...
                        <div class="relative shrink-0">
                            <button @click="openFilter = openFilter === 'model' ? null : 'model'"
                                ...
                                @else
                                    <i class="fa-solid fa-chevron-down text-[8px] ml-0.5 transition-transform"
                                        aria-hidden="true" :class="openFilter === 'model' ? 'rotate-180' : ''"></i>
                                @endif
                            </button>
                        ...
                        <div class="relative shrink-0">
                            <button @click="openFilter = openFilter === 'ratio' ? null : 'ratio'"
                                ...
                                @else
                                    <i class="fa-solid fa-chevron-down text-[8px] ml-0.5 transition-transform"
                                        aria-hidden="true" :class="openFilter === 'ratio' ? 'rotate-180' : ''"></i>
                                @endif
                            </button>
                            ...
                            @foreach($availableModels as $model)
                                <button wire:click="$set('filterModel', '{{ $model['id'] }}')"
                                    ...
                                    <div class="flex items-center gap-3 min-w-0 pr-4">
                                        <div
                                            class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 {{ $filterModel === $model['id'] ? 'bg-purple-500' : 'bg-white/10' }}">
