...
<div class="relative min-h-screen t2i-shell" @if($isGenerating) wire:poll.1500ms="pollImageStatus" @endif
    ...
    <button x-show="showScrollToBottom && !isFocused" x-cloak x-transition:enter="transition ease-out duration-300"
        ...
        class="fixed bottom-24 sm:bottom-28 right-4 sm:right-5 z-[50] w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-blue-600/90 hover:bg-blue-500 text-white shadow-lg shadow-blue-900/40 flex items-center justify-center transition-all active:scale-95 backdrop-blur-sm border border-white/10"
