    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div class="grid lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div class="lg:col-span-2 space-y-4">
                <div class="relative rounded-xl overflow-hidden bg-[#16161d] border border-[#2a2a35] aspect-[1/1]">
                    <img src="{{ $style->thumbnail }}" alt="{{ $style->name }}" class="w-full h-full object-cover"
                        onerror="this.src='/images/placeholder.svg'; this.onerror=null;">
                    <div class="absolute inset-0 bg-gradient-to-t from-[#16161d]/90 via-transparent to-transparent">
                    </div>
                ...
                {{--
                <div class="hidden lg:block bg-[#16161d] border border-[#2a2a35] rounded-xl p-4">
