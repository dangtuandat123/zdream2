<x-app-layout>
    ...
    <div 
        x-data="{ 
            open: false, 
            currentIndex: 0,
            images: @js($images->where('status', 'completed')->whereNotNull('storage_path')->pluck('image_url')->values()->toArray()),
            openGallery(index) {
    ...
    >
                    ...
                    <div class="group relative bg-white/[0.03] border border-white/[0.08] rounded-xl overflow-hidden hover:border-purple-500/30 transition-all">
                        ...
                        <div class="aspect-[3/4] relative">
                            @if($image->status === 'completed' && $image->storage_path)
                                <button 
                                    @click="openGallery({{ $galleryIndex }})"
        ...
        <template x-teleport="body">
            ...
            >
                ...
                <!-- Main Content -->
                <div class="flex-1 flex items-center justify-center relative overflow-hidden" @click="closeGallery()">
                    <!-- Nav Left -->
                    <button 
                        @click.stop="prev()"
