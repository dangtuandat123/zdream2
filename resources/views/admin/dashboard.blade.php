<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <a href="{{ route('admin.users.index') }}" class="bg-white/[0.03] border border-white/[0.08] rounded-xl p-4 hover:border-purple-500/30 hover:bg-white/[0.05] transition-all">
            ...
            <a href="{{ route('admin.styles.index') }}" class="bg-white/[0.03] border border-white/[0.08] rounded-xl p-4 hover:border-pink-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-3 mb-2">
            ...
            <a href="{{ route('admin.images.index') }}" class="bg-white/[0.03] border border-white/[0.08] rounded-xl p-4 hover:border-cyan-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-3 mb-2">
            ...
            <a href="{{ route('admin.transactions.index') }}" class="bg-white/[0.03] border border-white/[0.08] rounded-xl p-4 hover:border-green-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-3 mb-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="{{ route('admin.users.index') }}" class="group bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:border-purple-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-white group-hover:text-purple-300 transition-colors">Quản lý Users</h3>
            ...
            <a href="{{ route('admin.styles.index') }}" class="group bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:border-pink-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-white group-hover:text-pink-300 transition-colors">Quản lý Styles</h3>
            ...
            <a href="{{ route('admin.images.index') }}" class="group bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:border-cyan-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-white group-hover:text-cyan-300 transition-colors">Quản lý Ảnh</h3>
            ...
            <a href="{{ route('admin.transactions.index') }}" class="group bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:border-green-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-white group-hover:text-green-300 transition-colors">Lịch sử giao dịch</h3>
            ...
            <a href="{{ route('admin.settings.index') }}" class="group bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:border-yellow-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-white group-hover:text-yellow-300 transition-colors">Cài đặt</h3>
                        <p class="text-white/50 text-sm">API keys, defaults</p>
                    </div>
                    <i class="fa-solid fa-chevron-right w-4 h-4 text-white/30 ml-auto group-hover:text-yellow-400 transition-colors"></i>
                </div>
            </a>
            <a href="{{ route('home') }}" class="group bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:border-indigo-500/30 hover:bg-white/[0.05] transition-all">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-white group-hover:text-indigo-300 transition-colors">Xem trang chủ</h3>
                        <p class="text-white/50 text-sm">Xem như người dùng</p>
                    </div>
                    <i class="fa-solid fa-chevron-right w-4 h-4 text-white/30 ml-auto group-hover:text-indigo-400 transition-colors"></i>
                </div>
            </a>
        </div>
    </div>
