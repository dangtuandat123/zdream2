            ...
            <div class="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][subject]" value="{{ old('config_payload.prompt_defaults.subject') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][action]" value="{{ old('config_payload.prompt_defaults.action') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][style]" value="{{ old('config_payload.prompt_defaults.style') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][context]" value="{{ old('config_payload.prompt_defaults.context') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][mood]" value="{{ old('config_payload.prompt_defaults.mood') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][lighting]" value="{{ old('config_payload.prompt_defaults.lighting') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][color]" value="{{ old('config_payload.prompt_defaults.color') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][details]" value="{{ old('config_payload.prompt_defaults.details') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][technical]" value="{{ old('config_payload.prompt_defaults.technical') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][custom]" value="{{ old('config_payload.prompt_defaults.custom') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <input type="text" name="config_payload[prompt_defaults][misc]" value="{{ old('config_payload.prompt_defaults.misc') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <textarea name="config_payload[prompt_template]" rows="3"
                                          ...
                                          placeholder="{{ '{' }}{context}{{ '}' }}, {{ '{' }}{subject}{{ '}' }}, {{ '{' }}{action}{{ '}' }}, {{ '{' }}{style}{{ '}' }}">{{ old('config_payload.prompt_template') }}</textarea>
                            </div>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-xs text-white/50 mb-1">Tiền tố (Prefix)</label>
                                    <input type="text" name="config_payload[prompt_prefix]" value="{{ old('config_payload.prompt_prefix') }}"
                                           class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                                           placeholder="VD: Giữ bố cục, chỉ thay đổi phần mô tả:">
                                </div>
                                <div>
                                    <label class="block text-xs text-white/50 mb-1">Hậu tố (Suffix)</label>
                                    <input type="text" name="config_payload[prompt_suffix]" value="{{ old('config_payload.prompt_suffix') }}"
                                           class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
                            ...
                            <div>
                                ...
                                <select name="config_payload[prompt_strategy]" class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/40">
                                    ...
                                    <option value="standard" {{ old('config_payload.prompt_strategy') === 'standard' ? 'selected' : '' }}>Chuẩn (Chủ thể → Hành động → Phong cách → Bối cảnh)</option>
                                    <option value="narrative" {{ old('config_payload.prompt_strategy') === 'narrative' ? 'selected' : '' }}>Kể chuyện (Ưu tiên bối cảnh)</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="config_payload[width]" min="{{ config('services_custom.bfl.min_dimension', 256) }}" max="{{ config('services_custom.bfl.max_dimension', 1408) }}" step="{{ config('services_custom.bfl.dimension_multiple', 32) }}"
                                       value="{{ old('config_payload.width') }}"
                            ...
                            <div>
                                ...
                                <input type="number" name="config_payload[guidance]" min="1.5" max="10" step="0.1"
                                       value="{{ old('config_payload.guidance') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40">
                            </div>
                            <div>
                                ...
                                <input type="number" name="config_payload[safety_tolerance]" min="0" max="6" step="1"
                                       value="{{ old('config_payload.safety_tolerance') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40">
                            </div>
                            <div>
                                ...
                                <select name="config_payload[output_format]" class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40">
                                    <option value="">Mặc định</option>
                                    <option value="jpeg" {{ old('config_payload.output_format') === 'jpeg' ? 'selected' : '' }}>JPEG</option>
                                    <option value="png" {{ old('config_payload.output_format') === 'png' ? 'selected' : '' }}>PNG</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="config_payload[prompt_upsampling]" class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40">
                                    <option value="">Mặc định</option>
                                    <option value="1" {{ old('config_payload.prompt_upsampling') === '1' ? 'selected' : '' }}>Bật</option>
                                    <option value="0" {{ old('config_payload.prompt_upsampling') === '0' ? 'selected' : '' }}>Tắt</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="config_payload[raw]" class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40">
                                    <option value="">Mặc định</option>
                                    <option value="1" {{ old('config_payload.raw') === '1' ? 'selected' : '' }}>Bật</option>
                                    <option value="0" {{ old('config_payload.raw') === '0' ? 'selected' : '' }}>Tắt</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <input type="number" name="config_payload[image_prompt_strength]" min="0" max="1" step="0.05"
                                       value="{{ old('config_payload.image_prompt_strength') }}"
                                       class="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.08] text-white/90 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <label for="is_featured" class="text-sm text-white/70">Nổi bật (Home)</label>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        <input type="checkbox" id="is_new" name="is_new" value="1"
                               class="w-5 h-5 rounded bg-white/[0.03] border-white/[0.15] text-purple-500 focus:ring-purple-500/50"
                               {{ old('is_new') ? 'checked' : '' }}>
                        <label for="is_new" class="text-sm text-white/70">Mới (Badge)</label>
                    </div>
                </div>
            </div>
